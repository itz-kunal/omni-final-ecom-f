...
const Shop = () => {
    ...
    const { shop, products } = useContext(UserContext);
            ...
            <div className='w-full min-h-screen'>
                ...
                <div className='p-2 bg-slate-200'>
                    ...
                    <div className='flex flex-wrap justify-around'>
                        {
                            productLoading ? (<>Loading...</>) : (products.length > 0 ? (
                                products.map(product => (
                                    <ProductCard key={product._id} productId={product._id} name={product.name} image={product.image} />
                                ))
