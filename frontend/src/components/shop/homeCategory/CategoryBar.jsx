  ...
  return (
    ...
    <div className='w-full flex justify-center my-5'>
      <div className='w-[95%] bg-accent py-2 flex justify-between md:px-12 px-6 gap-6 font-semibold overflow-scroll no-scrollbar rounded-lg'>
          ...
          <CategoryImage imageLink='https://img.freepik.com/free-photo/beautiful-young-woman-colorful-jacket_140725-13007.jpg?t=st=1709403335~exp=1709406935~hmac=50538cc95e5256aaca35e9c396453edb411f522dcd61067f902b1fdd15dfc4b1&w=996'>Fashion</CategoryImage> 
