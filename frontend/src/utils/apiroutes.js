...
export const GET_ALL_SALES = `${ADMIN_ENDPOINTS}/all-sales`
export const GET_ALL_USERS = `${ADMIN_ENDPOINTS}/all-users`
export const ADD_NOTIFICATION = `${ADMIN_ENDPOINTS}/add-notification`
export const DELETE_NOTIFICATION = `${ADMIN_ENDPOINTS}/delete-notification`
export const EDIT_NOTIFICATION = `${ADMIN_ENDPOINTS}/edit-notification`
