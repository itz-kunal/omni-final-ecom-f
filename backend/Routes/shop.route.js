...
router.post('/nearby-shops', shopController.getNearByShops)
//take size in body and send shops based on size
router.post('/get-shops', shopController.getShops)
...
router.post('/search-in-shop', shopController.searchProductInShop)
